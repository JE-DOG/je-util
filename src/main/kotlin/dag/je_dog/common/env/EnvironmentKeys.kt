...
object EnvironmentKeys {
    ...
    const val NOTION_TASKS_DATABASE_LINK = "NOTION_TASKS_DATABASE_LINK"
    ...
    const val KAITEN_API_URL = "KAITEN_API_URL"
    const val KAITEN_API_TOKEN = "KAITEN_API_TOKEN"
    const val KAITEN_DEFAULT_SPACE_ID = "KAITEN_DEFAULT_SPACE_ID"
    const val KAITEN_BOARD_ID = "KAITEN_BOARD_ID"
    const val KAITEN_TASK_IDS = "KAITEN_TASK_IDS"
}
